...
const Signup = ({ tab, setIsSignup }) => {
  ...
  function handleSignup(event) {
    ...
    if (event.target.name === "jobSeekerSignup") {
      ...
      createUser({ ...jobSeekerFormData, userType: "jobseeker" });
      setJobSeekerFormData({
        email: "",
        firstName: "",
        lastName: "",
      ...
      createUser({ ...companyFormData, userType: "company" });
      setCompanyFormData({
        email: "",
        companyName: "",
        password: "",
  ...
  async function createUser({
    ...
    try {
      ...
      const ipAddress = await axios.get(
        "https://geo.ipify.org/api/v2/country?apiKey=at_1nnXMdXTEJ8Qo2xFtU8QsmVVksOt5"
      );
      const payload = {
        firstName,
        lastName,
      ...
      {tab === 0 && (
        <div className="p-4 md:p-5">
          ...
          >
            ...
            >
              {/* {loading ? (
                <div className="absolute top-[50%] left-[50%] scale-x-[-50%] scale-y-[-50%]">
